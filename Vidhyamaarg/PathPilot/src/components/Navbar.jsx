            ...
            <div className="relative mr-3">
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 focus:outline-none z-50">
                  <button
                    onClick={() => { changeFontSize('small'); setIsDropdownOpen(false); }}
                  ...
                  <button
                    onClick={() => { changeFontSize('normal'); setIsDropdownOpen(false); }}
                  ...
                  <button
                    onClick={() => { changeFontSize('large'); setIsDropdownOpen(false); }}
                  ...
                  <button
                    onClick={() => { changeFontSize('x-large'); setIsDropdownOpen(false); }}
